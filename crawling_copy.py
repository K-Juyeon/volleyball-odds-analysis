        ...
        for k in range(1, len(tr) + 1):
            ...
            if (gender == "여자"):
                ...
                if "흥국생명" in left or "흥국생명" in right:
                    ...
                    game_time_array = driver.find_element(By.XPATH, "//*[@id='wrp_content']/article[1]/table/tbody/tr/td[3]/table/tbody/tr[3]/td[7]").get_attribute("innerText").rstrip("m").split("h")
