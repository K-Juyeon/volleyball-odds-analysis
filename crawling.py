        ...
        for k in range(1, len(tr) + 1):
            ...
            if (gender == "여자"):
                ...
                if "흥국생명" in left or "흥국생명" in right:
                    ...
                    h_attackpercent = driver.find_element(By.XPATH, "//*[@id='tab1']/div[1]/div[2]/div/div[1]/div[1]/div[1]/span/span/span").get_attribute("innerText")
                    h_recievepercent = driver.find_element(By.XPATH, "//*[@id='tab1']/div[1]/div[2]/div/div[1]/div[1]/div[2]/span/span/span").get_attribute("innerText")
                    ...
                    a_attackpercent = driver.find_element(By.XPATH, "//*[@id='tab1']/div[1]/div[2]/div/div[1]/div[2]/div[1]/span/span/span").get_attribute("innerText")
                    a_recievepercent = driver.find_element(By.XPATH, "//*[@id='tab1']/div[1]/div[2]/div/div[1]/div[2]/div[2]/span/span/span").get_attribute("innerText")
