...
for i in range(1, 19):
    ...
    for j in range(2, len(select.options) + 1):
        ...
        for k in range(1, len(tr) + 1):
            left = driver.find_element(By.XPATH, "//*[@id='type1']/div/table/tbody/tr[" + str(k) + "]/td[4]").get_attribute("innerText")
            right = driver.find_element(By.XPATH, "//*[@id='type1']/div/table/tbody/tr[" + str(k) + "]/td[5]").get_attribute("innerText")
                ...
                if "김연경" in kim_list:
                    for m in range(1, 6):
                        ...
                        if "starting" in starting_check:
                            ...
                            kim_block = driver.find_element(By.XPATH, "//*[@id='" + team + "']/div/div[2]/table[2]/tbody/tr[" + str(n + 1) + "]/td[9]").get_attribute("innerText")
                            kim_miss = driver.find_element(By.XPATH, "//*[@id='" + team + "']/div/div[2]/table[2]/tbody/tr[" + str(n + 1) + "]/td[10]").get_attribute("innerText")
                            kim_successpercent = driver.find_element(By.XPATH, "//*[@id='" + team + "']/div/div[2]/table[2]/tbody/tr[" + str(n + 1) + "]/td[11]").get_attribute("innerText")
    ...
    f.close()
        ...
        #     print("팀 기록 페이지 NoSuchElementException 오류")
        #
        # try :
        #     pass
        #
        # except NoSuchElementException as e :
        #     print("선수 기록 페이지 NoSuchElementException 오류")
