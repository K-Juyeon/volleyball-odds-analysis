                ...
                if driver.find_element(By.CSS_SELECTOR, "#type1 > div > table > tbody > tr:nth-child(" + str(k) + ") > td:nth-child(3)").size.get("width") < 40 :
                    ...
                    if (gender == "여자"):
                        ...
                        if "흥국생명" in left or "흥국생명" in right:
                            ...
                            if check_element("//*[@id='wrp_content']/article[1]/table/tbody/tr/td[3]/table/tbody/tr[3]/td[7]") :
                                ...
                                if "흥국생명" in h_team:
                                    if check_element("//*[@id='tab2']/h4[2]") :
                                        if check_element("//*[@id='tab2']/div[3]/ul/li[1]/a") :
                                            driver.find_element(By.XPATH, "//*[@id='tab2']/div[3]/ul/li[1]/a").send_keys(Keys.ENTER)
                                        else :
                                    ...
                                    if check_element("//*[@id='tab2']/h4[2]") :
                                        if check_element("//*[@id='tab2']/div[3]/ul/li[1]/a"):
                                            driver.find_element(By.XPATH, "//*[@id='tab2']/div[3]/ul/li[2]/a").send_keys(Keys.ENTER)
                                        else:
